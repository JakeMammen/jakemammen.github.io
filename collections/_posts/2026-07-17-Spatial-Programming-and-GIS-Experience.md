---
layout: post
title: "Spatial Programming and GIS Experience"
date: 2026-07-17
authors: ["Jake Mammen"]
categories: ["Geospatial", "GIS", "Experience and Skills", "Research"]
description: "GIS framework to create a geoprocessing program for analysis"
thumbnail: "/assets/images/gen/blog/Density_Turbine_ArcMap-thumbnail.jpg"
image: "/assets/images/gen/blog/Density_Turbine_ArcMap.jpg"
---

## Description

This project uses a GIS framework to create a geoprocessing program that analyzes land suitability for wind turbines based off certain factors such as environmental, ecological, cultural, human settlement, and physical infrastructure to assess the impact wind turbine placement has on local communities. More specifically differences in wind speed; distances from a road network, urban areas, and differences in the topography of the land which could prove to be the primary factors in determining land suitability for wind turbines across the United States. This project uses a GIS and programming approach to analyze various energy and geographic datasets. As a result, the various patterns are illustrated through the use of maps by determining wind turbine placement and in return provide some useful information for planners and engineers to aid in decision making.
...
<img src="/assets/images/gen/blog/Buffer_Airport_Turbine_ArcMap.jpg">
