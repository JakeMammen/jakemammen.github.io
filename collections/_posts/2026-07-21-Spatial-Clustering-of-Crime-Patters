---
layout: post
title: "Spatial Clustering of Crime Patterns in Fort Worth, TX"
date: 2026-07-21
authors: ["Jake Mammen"]
categories: ["Geospatial", "GIS", "Experience and Skills", "Research"]
description: "K-Means Analysis of Robbery, Commercial Burglary, and Kidnapping at the Census Block Level"
thumbnail: "/assets/images/gen/blog/BG_clusters_plot-thumbnail.png"
image: "/assets/images/gen/blog/BG_clusters_plot.png"
---

# Description
This project applies **machine-learning based clustering** (k-means clustering) to explore spatial patterns in selected serious crimes across Fort Worth, Texas. By aggregating counts of robbery, commercial burglary, and kidnapping incidents to census block groups, we can identify clusters of similar crime profiles and visualize them on a map.
...
title("Scree Plot")
```
<img src="/assets/images/gen/blog/Scree_plot.png">
...
<img src="/assets/images/gen/blog/BG_clusters_plot.png">
...
<img src="/assets/images/gen/blog/blocks_per_cluster.png">

**Mean counts of each crime type in each cluster**

<img src="/assets/images/gen/blog/mean_counts.png">